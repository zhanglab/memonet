...
for n in n_neighbors:
  ...
  for res in louvain_resolution:
    ...
    #path = '/work/pi_yingzhang_uri_edu/kdunton/RNAseq/data/memonet_data/counts_matrices/L23_DGmtx_dec15.csv'
    path = '/work/pi_yingzhang_uri_edu/kdunton/RNAseq/cluster_by_genes/DESC_parameter_test/L23_0.3_DGmtx_dec15.csv'
    print("Path:"+ str(path))
    adata = sc.read(path)
    print("adata initial")
    print(adata)
    ...
    save_dir = ["result_DESC15.n"+str(n)+".L"+str(res)]
      #save_dir is a list
    #convert to string
    ...
    print(color)
    save = ["desc.dec15.n" + str(n) + ".L" + str(res) + ".png"]
    print(save)
...
# tsne coordinates:
    ...
    #save_tsne = ["tsne_dec15.n" + str(n) + ".L" + str(res) + ".csv"]
...
# umap coordinates:
    ...
    save_umap = ["umap_dec15.n" + str(n) + ".L" + str(res) + ".csv"]
...
# clustering result/labels:
    ...
    save_clu = ["clusters_dec15.n" + str(n) + ".L" + str(res) + ".csv"]
