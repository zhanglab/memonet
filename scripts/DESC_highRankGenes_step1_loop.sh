...
#       sbatch /work/pi_yingzhang_uri_edu/kdunton/scripts/katie-scripts/RNAseq/DESC_highRankGenes_step1_loop.sh
# takes ~ 3hrs
...
python /work/pi_yingzhang_uri_edu/kdunton/scripts/katie-scripts/RNAseq/DESC_highRankGenes_step1_loop.py
